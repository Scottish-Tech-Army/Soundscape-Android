...
enum class StringKey {
    ...
    // Abbreviated cardinals ("NW"). Shown where space is tight - the beacon card on the
    // home screen - while speech always gets the spelled-out form above.
    DirectionsCardinalNorthAbb,
    DirectionsCardinalNorthEastAbb,
    DirectionsCardinalEastAbb,
    DirectionsCardinalSouthEastAbb,
    DirectionsCardinalSouthAbb,
    DirectionsCardinalSouthWestAbb,
    DirectionsCardinalWestAbb,
    DirectionsCardinalNorthWestAbb,
