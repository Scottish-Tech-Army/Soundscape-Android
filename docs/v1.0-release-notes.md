...
# Release notes for Soundscape 1.x

These are the release notes for the 1.x versions of Soundscape, up to and including 1.1. For the
current release, see [Release notes]({{ "/release-notes.html" | relative_url }}).
