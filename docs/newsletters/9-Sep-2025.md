...
## Open beta releases
We've had a number of open beta versions released now and lots of improvements and changes which we have listed in the [release notes]({{ "/release-notes.html" | relative_url }}).
