...
We've been working through all of these as efficiently as we can and have already made a couple of new releases that fix some of the initial reported issues. We list these in the [release notes]({{ "/release-notes.html" | relative_url }}).
