...
Hlasové příkazy se hodí, když máte telefon v kapse, plné ruce nebo se vám nechce zastavovat kvůli stisknutí tlačítka. Fungují, i když Soundscape běží na pozadí a když je telefon zamčený, a vyžádání hlášení aplikaci neotevře.

Poslouchá váš asistent, ne Soundscape, takže aplikace nikdy nezabírá mikrofon a vaše bluetooth sluchátka zůstávají v režimu s vysokou kvalitou zvuku místo přepnutí do horšího režimu používaného pro telefonní hovory.

## Jak to funguje?

Není třeba se učit žádné přesné fráze. Řekněte vlastními slovy, co chcete, a asistent to přiřadí k některé z níže uvedených akcí. Názvy tras a značek se porovnávají volně, takže obvykle stačí část názvu.
...
Spustil některou z vašich uložených tras podle názvu, přešel na další trasový bod, vrátil se na předchozí, ztlumil maják nebo trasu zastavil.
