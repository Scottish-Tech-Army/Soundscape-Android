...
Talvez você queira criar e usar uma rota em um lugar que já conhece, para ajudar a se manter no caminho certo. Ou talvez queira usar uma rota para aprender um trajeto novo.
