...
Tap anywhere on the map to see every extract that covers that point — a country, the region within it, and any city extract there are all listed together, with the same name, size and town list shown in the **Offline maps** screen inside the app.
