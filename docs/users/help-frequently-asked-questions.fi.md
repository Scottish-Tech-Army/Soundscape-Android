...
1. Majakkaa käytettäessä ei ole yhtä *oikeaa* suuntaa kulkea – Soundscapen kanssa sinä valitset, miten sinne menet;

2. Korkeampi *ring* auttaa vain paikantamaan määränpään suunnan – se ei kerro, miten sinne pääsee;
