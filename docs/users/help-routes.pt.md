...
Poderá pretender criar e utilizar uma rota num local conhecido para se certificar de que está no caminho certo, ou como ferramenta para o ajudar a familiarizar-se com um percurso novo.
