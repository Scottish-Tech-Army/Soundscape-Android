...
You can set an audio beacon on any business, place, point of interest, address or intersection. To add a beacon, view the details for a location by either using the search bar or by tapping one of the *"Places Nearby"*, *"Markers and Routes"* or *"Current Location"* buttons and selecting a location. From the *"Location Details"* screen select the *"Start Audio Beacon"* button. Tapping this returns you to the home screen and turns on an audible beacon coming from the direction of the place you selected. The name of the place you have chosen, along with its distance and physical address (if available), will be shown on the main app screen.

### How do I use a beacon like a pro?
You can think of the audible beacon as a *"lighthouse for the ears"*, telling you where your destination lies relative to your location, as the crow flies. Like a lighthouse, it does not give you a route — you may need to make many navigation choices along the way, just as a sailboat makes several strategic *"tacks"* to get closer to a lighthouse. The continuous rhythmic sound of the audible beacon is spatialised from the direction of the destination and helps you stay aware of the destination’s location relative to you as you walk. When you are walking directly towards the destination, or you point the phone towards it, a higher‑pitched *"ring"* sound will be heard. This helps you pinpoint the destination’s direction because the rhythmic sound can sometimes be hard to perceive in noisy environments. When searching for the higher‑pitched *"ring"*, hold the phone flat and sweep it slowly; turning your head to face the same direction as the phone will give the best spatial audio experience.

The lighthouse metaphor for the beacon’s design suggests a few practical points:

1. There is no *"correct"* direction to travel when using the beacon — with Soundscape you choose how to get there;

2. The higher‑pitched *"ring"* helps you pinpoint the destination’s direction only — it does not tell you how to get there;

3. If you already generally know how to reach your destination, you may prefer to mute the beacon for most of your trip and turn it on only as you get nearer.
...
Yes, you can. Addresses are not listed by default but can be found using the search field. To save an address so you do not need to search for it again, add it as a marker from the *"Location Details"* screen by selecting the *"Save as Marker"* button.
...
Battery life varies significantly depending on which phone you own and how old it is. The biggest drain on your battery is having the screen on, so to maximise your phone’s battery life you should keep the screen locked whenever possible. To help minimise the impact on your phone battery, Soundscape now includes a Sleep Mode. To further reduce battery use, when you are not using Soundscape you should force close it via your phone’s App Switcher.

### How do I use Sleep Mode to minimise Soundscape’s impact on my phone battery?
...
Soundscape provides an ambient description of your surroundings to aid exploration and wayfinding. Using spatial audio, Soundscape will call out points of interest, parks, roads and intersections from the direction they actually sit in your immediate environment as you walk. For example, if you pass a shop on your right, you will hear the name of the shop sounding from your right. As you approach an intersection, you will hear each road name sounding from the direction it goes in — starting to your left, then ahead and to the right.

Rather than giving turn-by-turn directions like many other map applications, Soundscape plays an audible beacon from the direction of your destination, empowering you to get there on your own terms using your improved awareness of the environment and of where your destination is. Soundscape is designed to run in the background, so you can use a turn-by-turn navigation app while it continues to provide environmental awareness as you travel.
...
1. Immediately stop all audio: Double tap the screen with two fingers to turn off all audio immediately, including any callout that is currently playing and the beacon if it is on. Callouts will resume automatically when you approach the next intersection or point of interest, but the audible beacon will not. Select the *"unmute beacon button"* on the main screen to resume the beacon.

2. Stop automatic callouts: When you are not travelling or have reached a destination, you may not want Soundscape to continue announcing things around you. Instead of exiting the app, you can put Soundscape into Snooze Mode and it will wake when you leave, or put it into Sleep Mode and it will stay off until you choose to turn it back on. Alternatively, open *"Settings"* from the menu and turn all callouts off in the *"Manage Callouts"* section.

3. Stop the beacon: There are many situations where you might set a destination but not need the audible beacon. For example, you may already know how to get to your destination but still want automatic distance updates, or you might only want the beacon as you near the destination. In any case, you can choose when to hear the beacon by toggling the *"mute beacon"*/*"unmute beacon"* button on the main screen.

If you still want to interact with Soundscape but do not want automatic callouts, turn callouts off in *"Manage Callouts"* on the *"Settings"* screen (from the main menu). Or, if you will not be using Soundscape for a while, put it into Sleep or Snooze Mode using the *"Sleep"* button on the home screen.

### Do I need to hold the phone in my hand all the time?
No — you do not need to hold the phone all the time. When walking you can keep the phone in a bag, pocket, or wherever is convenient. Soundscape uses the direction you are walking to decide which callouts to announce to your left and to your right. When you stop moving, Soundscape cannot tell which way you are facing and, if the audible beacon is on, you will notice it get quieter until you start moving again. You can take the phone out to press the location and exploration buttons at the bottom of the screen whenever you need to — just hold the phone with the top pointing in the direction you are facing and the screen facing the sky. In this *"flat"* position Soundscape will use the phone’s compass to determine which way you are facing and provide accurate spatial callouts. If the beacon is on, it will also return to full volume.
