...
Les ordres de veu són útils quan portes el telèfon a la butxaca, tens les mans ocupades o prefereixes no aturar-te per prémer un botó. Funcionen mentre Soundscape s’executa en segon pla i mentre el telèfon està bloquejat, i demanar un avís de veu no obre l’aplicació.

Qui escolta és el teu assistent, no pas Soundscape, de manera que l’aplicació mai no ocupa el micròfon i els teus auriculars Bluetooth es mantenen en el mode d’àudio d’alta qualitat en lloc de passar al mode de menor qualitat que s’usa a les trucades.

## Com funciona?

No hi ha frases exactes per memoritzar. Demana el que vulguis amb les teves paraules i l’assistent ho associarà a una de les accions següents. Els noms de rutes i marcadors es reconeixen de manera aproximada, així que sol n’hi ha prou amb una part del nom.
...
Iniciï una de les teves rutes desades pel seu nom, passi al punt de ruta següent, torni a l’anterior, silenciï la balisa o aturi la ruta.
