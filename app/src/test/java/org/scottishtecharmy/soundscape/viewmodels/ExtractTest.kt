...
class ExtractTest {
    ...
    @Test
    fun extractCitiesShowsAlternateCitiesIfLocalCitiesEmpty() {
        val geojson =
            """{"type": "Feature", "geometry": {"type": "Polygon", 
            |"coordinates": [[[139.81691185318002, 37.56831909920214], 
            |[139.81452073905476, 37.84856243009939], [139.86499116717772, 37.84884359203526], 
            ...
            |"extract-size": 87491126, "extract-size-string":"0.4GB", 
            |"filename": "iwaki-jp.pmtiles"}}""".trimMargin()
        val extract = Extract((adapter.fromJson(geojson) as Feature))
    ...
    @Test
    fun extractCitiesShowsLocalCitiesIfPropertyExists() {
        val geojson =
            """{"type": "Feature", "geometry": {"type": "Polygon", 
            |"coordinates": [[[139.81691185318002, 37.56831909920214], 
            |[139.81452073905476, 37.84856243009939], [139.86499116717772, 37.84884359203526], 
