            ...
            results = runBlocking {
                withContext(gridState.treeContext) {
                    ...
                    val poiFeatureCollections =
                        gridState.getFeatureCollection(TreeId.POIS, userGeometry.location, 600.0)
                    ...
                    if (gridPoiFeatureCollection.features.isNotEmpty()) {
                        ...
                        while (true) {
                            val individualRelativePolygons = getRelativeDirectionsPolygons(userGeometry, RelativeDirections.INDIVIDUAL)
